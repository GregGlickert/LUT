...
#may not want to run this everytime to run change false to True
if False:
    ...
    build_env_bionet(
        ...
        report_vars=['v'],
        celsius=31.0,
        spikes_inputs=[('Blad_aff_virt', 'Blad_spikes.csv'),
                    ('EUS_aff_virt', 'EUS_spikes.csv'),
                    ('PAG_aff_virt', 'PAG_spikes.csv')], 
